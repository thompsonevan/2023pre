...
import kinematics.SwerveDriveOdometry;
import kinematics.SwerveModulePosition;
...
public class Drivetrain{
    ...
    public Drivetrain(){
        ...
        // positions = new SwerveModulePosition(distanceMeters, angle)
        ...
        //     new PIDController(.9, .4, 0),  //x Long side of field
        //     new PIDController(1.2, .4, 0), //y Short side of field
        ...
        // ProfiledPIDController thetaController = new ProfiledPIDController(100, 10, .09,  // Theta
        //     new TrapezoidProfile.Constraints(6.28, 3.14));

        // thetaController.enableContinuousInput(-Math.PI, Math.PI);

        // holonomicController = new HolonomicDriveController(
        // new PIDController(50, 10, .02),  //x Long side of field
        // new PIDController(50, 10, .02), //y Short side of field
        // thetaController); // (2Pk,PI) constrains to 1 2pi/sec
    ...
    public void zero(){
        ...
        odometry.resetPosition(Rotation2d.fromDegrees(Pigeon.getAngle()), 
            positions, 
            new Pose2d());
        // poseExstimator.resetPosition(new Pose2d(), Pigeon.getRotation2d());
    }
    ...
    private void setSwerveModuleStates(ChassisSpeeds chassisSpeeds) {
        ...
        frontLeftModule.set(states[0].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE * .2,
                        states[0].angle.getRadians());
        frontRightModule.set(states[1].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE * .2,
                        states[1].angle.getRadians());
        backLeftModule.set(states[2].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE * .2,
                        states[2].angle.getRadians());
        backRightModule.set(states[3].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE * .2,
                        states[3].angle.getRadians());
    }

    private void autoSetSwerveModuleStates(ChassisSpeeds chassisSpeeds) {
        states = kinematics.toSwerveModuleStates(chassisSpeeds);
        SwerveDriveKinematics.desaturateWheelSpeeds(states, MAX_VELOCITY_METERS_PER_SECOND);
    ...
    public void teleAction(TeleopCommander commander){
        ...
        // SmartDashboard.putNumber("Front Left Drive", ((-frontLeftDrive.getSelectedSensorPosition() / 2048) * SdsModuleConfigurations.MK4_L2.getDriveReduction()) * (Math.PI * SdsModuleConfigurations.MK4_L2.getWheelDiameter()));
        // SmartDashboard.putNumber("Front Right Drive", ((frontRightDrive.getSelectedSensorPosition() / 2048) * SdsModuleConfigurations.MK4_L2.getDriveReduction()) * (Math.PI * SdsModuleConfigurations.MK4_L2.getWheelDiameter()));
        // SmartDashboard.putNumber("Back Left Drive", ((backLeftDrive.getSelectedSensorPosition() / 2048) * SdsModuleConfigurations.MK4_L2.getDriveReduction()) * (Math.PI * SdsModuleConfigurations.MK4_L2.getWheelDiameter()));
        // SmartDashboard.putNumber("Back Right Drive", ((backRightDrive.getSelectedSensorPosition() / 2048) * SdsModuleConfigurations.MK4_L2.getDriveReduction()) * (Math.PI * SdsModuleConfigurations.MK4_L2.getWheelDiameter()));
        // SmartDashboard.putNumber("Moudle Angle", backLeftEncoder.getAbsoluteAngle());

        SmartDashboard.putNumber("Radians", backLeftModule.getSteerAngle());
    ...
    public void runAuto(State desiredState, Rotation2d targetTheta){
        frontLeftPos = (frontLeftDrive.getSelectedSensorPosition() / 2048) * SdsModuleConfigurations.MK4_L2.getDriveReduction() * Math.PI * SdsModuleConfigurations.MK4_L2.getWheelDiameter();
        frontRightPos = (frontRightDrive.getSelectedSensorPosition() / 2048) * SdsModuleConfigurations.MK4_L2.getDriveReduction() * Math.PI * SdsModuleConfigurations.MK4_L2.getWheelDiameter();
        backLeftPos = (backLeftDrive.getSelectedSensorPosition() / 2048) * SdsModuleConfigurations.MK4_L2.getDriveReduction() * Math.PI * SdsModuleConfigurations.MK4_L2.getWheelDiameter();
        backRightPos = (backRightDrive.getSelectedSensorPosition() / 2048) * SdsModuleConfigurations.MK4_L2.getDriveReduction() * Math.PI * SdsModuleConfigurations.MK4_L2.getWheelDiameter();
